...
struct NES {
    ...
    void write_mem(size_t addr, uint8_t *buf, size_t size) {
    ...
    void reset() {
        ...
        // TODO : Remove this!
        write_mem(0x0600, program, ARR_LEN(program));
        write_mem(cpumem::RESET_VECTOR, reset_vector, ARR_LEN(reset_vector));
    }
